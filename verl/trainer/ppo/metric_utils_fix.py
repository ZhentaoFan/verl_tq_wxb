...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> dict[str, Any]:
    ...
    # In sync trainer path, response_length derived from attention_mask tail slicing can
    # be misaligned for short samples after padding. Use response_mask directly for abort detection.
    aborted_mask = (batch.batch["response_mask"].sum(-1) == 0).bool()
